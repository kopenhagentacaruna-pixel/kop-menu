# Etiquetas Kopenhagen Tacaruna

Pasta pronta para publicar no GitHub Pages.

## Como publicar

1. Envie todo o conteudo desta pasta `etiquetas` para o repositorio do GitHub.
...
Use o botao `Gerar Imagens` para criar folhas PNG em A4 paisagem. Esse modo evita desalinhamentos de impressao causados pelo HTML/CSS do navegador.
